...
import newProduct from "/public/assets/new.png"

function NewProductsPage() {
    const {data: getProductsInDiscount, isLoading: loadingProductsInDiscount} = useGetProductsInNewQuery();
            ...
            <section id="newProductsPage">
                <div className="container">
                    <div className="navigation">
                        ...
                        <div className="selected navText">Yeni məhsullar</div>
                    </div>
                    <div className="row">
