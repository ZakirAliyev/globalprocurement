...
import { useGetCategoriesQuery, usePostProductsMutation } from '../../../services/adminApi.jsx';
import './index.scss';
...
const ProductAdd = () => {
    ...
    const [createProduct, { isLoading: isSubmitting }] = usePostProductsMutation();
    const { data: getCategories, isLoading: isCategoriesLoading, error: categoriesError } = useGetCategoriesQuery();
    ...
    const onSubmit = async (values) => {
        try {
            ...
            message.success('Məhsul uğurla yaradıldı!');
            navigate('/cp/products');
        } catch (error) {
            console.error('Failed to create product:', error);
            message.error(error?.data?.message || 'Məhsul yaradılması uğursuz oldu!');
        }
    };
    ...
    return (
        <Flex vertical gap="middle" className="product-add-container">
            <h2 className="product-add-title">Yeni Məhsul Yarat</h2>
            {isCategoriesLoading ? (
                        ...
                        <Form className="product-add-form">
                            <Row gutter={[16, 16]}>
                                ...
                                <Col xs={24} sm={12}>
                                    ...
                                    <Field name="NameEng" as={Input} placeholder="Məhsul Adı (İngiliscə)" className="field-input" />
                                    <ErrorMessage name="NameEng" component="div" className="error-message" />
                                </Col>
                                <Col xs={24} sm={12}>
                                    <label className="field-label">Məhsul Adı (Rusca)</label>
                                    <Field name="NameRu" as={Input} placeholder="Məhsul Adı (Rusca)" className="field-input" />
                                ...
                                <Col xs={24} sm={12}>
                                    ...
                                    <Field name="Price" as={Input} type="number" placeholder="Qiymət" step="0.01" className="field-input" />
                                        ...
                                        {({ field }) => (
                                            <Cascader
                                                ...
                                                onChange={(value, selectedOptions) => {
                                                    setFieldValue('CategoryId', value[1]); // yalnız subcategory ID
                                                }}
                                                ...
                                                displayRender={(labels, selectedOptions) => {
                                                    ...
                                                    return selectedOptions[selectedOptions.length - 1].label; // yalnız alt kateqoriya adı göstər
                                                }}
                                            />
                                        )}
                                    </Field>
                                ...
                                <Col xs={24} sm={12}>
                                    <label className="field-label">Populyar məhsul</label>
                                    <Field name="isPopular" as={Checkbox} checked={values.isPopular}>
                                        Populyar
                                    </Field>
                                </Col>
                                <Col xs={24} sm={12}>
                                    <label className="field-label">Yeni məhsul</label>
                                    <Field name="isNew" as={Checkbox} checked={values.isNew}>
                                        Yeni
                                    </Field>
                                </Col>
                                <Col xs={24} sm={12}>
                                    <label className="field-label">Əla təklif</label>
                                    <Field name="isGreatOffer" as={Checkbox} checked={values.isGreatOffer}>
                                        Əla təklif
                                    </Field>
                                </Col>
                                        ...
                                        <Row gutter={[16, 16]} key={index} className="spec-measure-row">
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Specifications[${index}].key`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Specifications[${index}].keyEng`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Specifications[${index}].keyRu`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Specifications[${index}].value`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Specifications[${index}].valueEng`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Specifications[${index}].valueRu`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={2}>
                                                <Button
                                                    type="danger"
                                        ...
                                        <Row gutter={[16, 16]} key={index} className="spec-measure-row">
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Measures[${index}].key`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Measures[${index}].keyEng`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Measures[${index}].keyRu`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Measures[${index}].value`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Measures[${index}].valueEng`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={4}>
                                                <Field
                                                    ...
                                                    className="field-input"
                                                />
                                                <ErrorMessage name={`Measures[${index}].valueRu`} component="div" className="error-message" />
                                            </Col>
                                            <Col xs={24} sm={2}>
                                                <Button
                                                    type="danger"
